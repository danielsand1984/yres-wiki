...
De database telt **102 stored procedures, 56 functions en 41 views** (geteld op de deploy-bron, juli 2026). Functions staan op [Functions](./functions.md); logtabellen en views op [Logs & views](./logs-views.md).
