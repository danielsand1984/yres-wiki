...
Oudere documentatie verwijst naar `[Monitoring].[vwLoadMonitor]`. Die view is **niet gedeployd** (hij komt alleen voor in een verouderd `.sqlproj_backup`). Gebruik in plaats daarvan **`vwLoads`** (pipeline-tijdlijn) of **`vwMonitor`** (breder).
:::
