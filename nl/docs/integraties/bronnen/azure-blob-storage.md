...
Azure Blob Storage is een **bestandsbron**: de metadata-stap (`GetMetaData`) wordt **overgeslagen** — er is geen databasedictionary. Yres leest de structuur uit de bestanden zelf; je definieert de bestanden en de parse-opties rechtstreeks bij het toevoegen. Je voegt per bestand (of bestandspatroon) een tabel toe en kiest daarbij het load-type: **FULL**, **OVERWRITE** of **IMAGE** (bij onderhoud achteraf ook **RELOAD** en **ADDITIONAL**). **DELTA** en **DELTAIMAGE** bestaan niet voor bestandstabellen.
