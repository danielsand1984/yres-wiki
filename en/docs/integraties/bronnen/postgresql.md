...
description: Connect PostgreSQL to Yres — connection requirements.
---
...
- **Database name** — The name of the specific database/schema you want to connect to (visible via `\l` in psql or from your DBA).
