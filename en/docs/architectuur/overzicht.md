...
| Layer | Technology |
| --- | --- |
| Sources | Exact, AFAS, SAP, Salesforce, databases, REST APIs [and more](https://oogopdata.nl/en/wiki/integraties/catalogus/) |
...
By default Yres runs entirely within the customer's **own Azure tenant** — data, infrastructure and costs remain with the customer. Hosting _by Yres_ is an explicit option.
